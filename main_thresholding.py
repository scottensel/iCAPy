from input_scripts.Inputs_Thresholding_data import setup_thresholding_data_params
...
###############################################################################
# DESCRIPTION
# This is the main script used to run the second step, thresholding, of the
...
def main():
    # Data-related params
    param = setup_thresholding_data_params()
