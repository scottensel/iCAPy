...
def evaluate_soft_cluster_thres(TC_stats, param, fid=None):
    ...
    fig.savefig(os.path.join(out_dir, "BICsum.svg"), format="svg", bbox_inches="tight")
    fig.savefig(os.path.join(out_dir, "BICsum.png"), format="png", bbox_inches="tight")
    ...
    fig.savefig(os.path.join(out_dir, "BICdist.svg"), format="svg", bbox_inches="tight")
    fig.savefig(os.path.join(out_dir, "BICdist.png"), format="png", bbox_inches="tight")
    ...
    fig.savefig(os.path.join(out_dir, "AICsum.svg"), format="svg", bbox_inches="tight")
    fig.savefig(os.path.join(out_dir, "AICsum.png"), format="png", bbox_inches="tight")
    ...
    fig.savefig(os.path.join(out_dir, "AICdist.svg"), format="svg", bbox_inches="tight")
    fig.savefig(os.path.join(out_dir, "AICdist.png"), format="png", bbox_inches="tight")
